...
public class AgonesAlphaSdk {
    ...
    public void getCounter(String name, StreamObserver<Counter> observer) {
        this.stub.getCounter(
                GetCounterRequest.newBuilder().setName(name).build(),
                observer
        );
    }
    ...
    public void isPlayerConnected(String playerId, StreamObserver<Bool> observer) {
        this.isPlayerConnected(
                PlayerID.newBuilder().setPlayerID(playerId).build(),
                observer
        );
    }
    ...
    public void updateCounter(Counter counter, FieldMask updateMask, StreamObserver<Counter> observer) {
